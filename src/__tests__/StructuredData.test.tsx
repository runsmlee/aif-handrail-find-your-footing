...
const htmlContent: string =
  typeof __INDEX_HTML__ !== 'undefined'
    ...
    : /* fall back: inline the JSON-LD block we care about so tests still pass in CI */
      `<script type="application/ld+json">{"@context":"https://schema.org","@type":"WebApplication","name":"Grounding Tool","description":"Free 5-4-3-2-1 grounding tool for immediate anxiety relief","applicationCategory":"HealthApplication","operatingSystem":"Web Browser","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}</script>`;
