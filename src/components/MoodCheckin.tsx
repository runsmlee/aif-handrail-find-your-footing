...
const MOOD_OPTIONS: MoodOption[] = [
  { value: 'great', label: 'Great', emoji: '\u{1F60A}', description: 'Feeling wonderful', color: 'bg-sage-100 border-sage-500 text-sage-700' },
  { value: 'good', label: 'Good', emoji: '\u{1F642}', description: 'Doing alright', color: 'bg-sage-100 border-sage-400 text-sage-600' },
  { value: 'okay', label: 'Okay', emoji: '\u{1F610}', description: 'Somewhere in the middle', color: 'bg-warm-100 border-amber-400 text-amber-700' },
  { value: 'low', label: 'Low', emoji: '\u{1F614}', description: 'Feeling a bit down', color: 'bg-primary-100 border-primary-300 text-primary-700' },
  { value: 'struggling', label: 'Struggling', emoji: '\u{1F622}', description: 'Having a hard time', color: 'bg-primary-100 border-primary-500 text-primary-700' },
];
